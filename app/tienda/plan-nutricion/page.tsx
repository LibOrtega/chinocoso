              ...
              <div className="text-center">
                ...
                <div className="mt-8 text-center">
                  <a
                    ...
                    className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white py-2 px-4 text-sm rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg"
                  >
