              ...
              <div className="text-center">
                ...
                <div className="mt-6">
                  <a
                    ...
                    className="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white py-4 px-8 text-lg rounded-lg transition-colors duration-200 shadow-lg hover:shadow-xl"
                  >
